...
#DIM_VALUES=(2000 10000 20000)
#RAM_VALUES=(40 50 60)  # Memory in GB, took 100GB for other workers values (2,4,8)
#TIME_VALUES=(1 3 8)
...
LOG_DIR=".duct/logs_segment_squidpy"
LOG_PREFIX="\${LOG_DIR}/\${METHOD}_\${DIM}_\${WORKERS}"

mkdir -p "\$LOG_DIR"

monitor -d 5 -l \${LOG_PREFIX}monitor.log -- pixi run --frozen -e squidpy duct -p \${LOG_PREFIX} \\
  --sample-interval 0.5 \\
  --report-interval 5 \\
